...
public class ArrayList<AnyType> extends AbstractCollection<AnyType> implements List<AnyType> {
	 ...
	 * @param idx
	 *            the index to start the iterator. Use size() to do complete reverse traversal. Use 0 to do complete forward
	 *            traversal.
	...
	/**
	 * This is the implementation of the ArrayListIterator. It maintains a notion of a current position and of course the
	 * implicit reference to the ArrayList.
	 */
