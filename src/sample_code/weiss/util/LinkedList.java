...
public class LinkedList<AnyType> extends AbstractCollection<AnyType> implements List<AnyType>, Queue<AnyType> {
	...
	/**
	 * This is the implementation of the LinkedListIterator. It maintains a notion of a current position and of course the
	 * implicit reference to the LinkedList.
	 */
