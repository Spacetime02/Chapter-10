...
public interface Map<KeyType, ValueType> extends Serializable {
	...
	/**
	 * The interface used to access the key/value pairs in a map. From a map, use entrySet().iterator to obtain a iterator
	 * over a Set of pairs. The next() method of this iterator yields objects of type Map.Entry.
	 */
