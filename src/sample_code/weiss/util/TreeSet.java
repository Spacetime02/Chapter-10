...
public class TreeSet<AnyType> extends AbstractCollection<AnyType> implements SortedSet<AnyType> {
	...
	private int compare(AnyType lhs, AnyType rhs) {
		if (cmp == null)
			return ((Comparable<AnyType>) lhs).compareTo(rhs);
		else
	...
	/**
	 * This is the implementation of the TreeSetIterator. It maintains a notion of a current position and of course the
	 * implicit reference to the TreeSet.
	 */
