...
public abstract class AbstractCollection<AnyType> implements Collection<AnyType> {
	...
	/**
	 * Returns true if this collection contains x. If x is null, returns false. (This behavior may not always be
	 * appropriate.)
	 * 
	 * @param x
	...
	/**
	 * Return true if items in other collection are equal to items in this collection (same order, and same according to
	 * equals).
	 */
