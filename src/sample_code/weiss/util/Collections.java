...
public class Collections {
	 ...
	 *             if objects in collection cannot be compared.
	 */
	public static <AnyType extends Object & Comparable<? super AnyType>> AnyType max(Collection<? extends AnyType> coll) {
	...
	/*
	 * Returns a comparator that imposes the reverse of the default ordering on a collection of objects that implement the
